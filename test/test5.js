...
function testFunc() {
	console.log('test5 started - testing of use of message format')
	const fname = './test5.txt';
	const tname = 'test5';
	const message = 'Loging another text message.';

	var f1 = lg.create({'name': tname, 'file': fname, 'format': 'T'});
